...
while not quit:
    try:
        ...
        # Со словарем будет проще работать

        if addr not in clients: 
        # Делаем словарь из адрессов и привязываем к ним имена что отправляються
        # первым сообщением
        ...
        # Условие если первым словом в сообщение являетсья имя
